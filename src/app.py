...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice drills, scrimmages, and interschool basketball games",
    ...
    "Math Olympiad": {
        "description": "Prepare for regional and national mathematics competitions",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["ethan@mergington.edu", "isabella@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments and compete in science fairs",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
